...
const PricingSection = () => {
  return (
    <div className='mt-[113px] pr-[20px] pl-[20px] md:pr-[74px] md:pl-[74px]'>
        ...
        <div className='mt-[6px]'>
            <p className="font-inter font-normal text-[15px] text-center selection:bg-primary/50 selection:text-[#fff]">Choose a plan that fits your needs and unlock the full potential of LoyalMind AI.</p>
        </div>
            ...
            <div className='bg-neutral p-[32px] w-full rounded-[20px] md:w-[347px]'>
                ...
                <div className='mt-[20px] flex flex-col space-y-[4px]'>
                    <div className='flex flex-row space-x-[4px] items-center'>
                        ...
                        <p className='font-inter font-normal text-[12px] selection:bg-primary/50 selection:text-[#fff]'>LoyalMind Chatbot</p>
                    </div>
                    <div className='flex flex-row space-x-[4px] items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#00796B" width="24" height="24">
                            <path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11.0026 16L18.0737 8.92893L16.6595 7.51472L11.0026 13.1716L8.17421 10.3431L6.75999 11.7574L11.0026 16Z"></path>
