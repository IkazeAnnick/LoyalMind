...
const Navigation = () => {
    ...
    const items = [
        ...
        {
            label: (
              <div onClick={() => switchLanguage('fr')} className='flex flex-row space-x-[6px] items-center'>
                  <div className='w-[20px] h-[20px] rounded-full'>
                      <img src='/images/france_icon.png' className='w-full h-full object-center object-cover' alt='eng' />
                  </div>
                  <div>Français</div>
              </div>
            ),
  ...
  return (
    <div className='bg-[#fff] h-[50px] w-full flex pr-[20px] pl-[20px] flex-row justify-between items-center md:pr-[74px] md:pl-[74px] md:h-[80px]'>
        <div>
            <p className='font-montserrat font-bold text-dark cursor-pointer'>LoyalMind AI</p>
        </div>
